    ...
    <div className="leads_body_bg">
      <div className="leads_checkResponse">
        ...
        <div className="leads_checkResponse_inner">
          <h5>{/* Lead ID <span>{details.lead_id} </span> */}</h5>
          <p>
            Status{" "}
            <span>
          ...
          <div className="leads_checkResponse_inner_btns_div">
            <div>
              ...
              <div className="success_class">
                {details.status_response == "Accepted"
                  ? "Accepted"
                  : "Rejected"}{" "}
              </div>
            </div>
            <div>
              ...
              <br />
              <div className="success_class">
                {details.buyer_status_response == "true"
                  ? "Success"
                  : "Failure"}{" "}
              </div>
            </div>
            <div>
              <button>Price</button>
              <br />
              <div className="success_class">{details.price}</div>
            </div>
            <div>
              <button>Cost</button>
              <br />
              <div className="success_class">{details.cost}</div>
            </div>
            <div>
